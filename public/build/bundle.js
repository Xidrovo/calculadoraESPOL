    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			p0 = element("p");
    			p0.textContent = "Esta herramienta te ayuda a calcular el promedio de las\n                    calificaciones de tus materias.";
    			t1 = space();
    			p1 = element("p");
    			p1.textContent = "Las calificaciones se ingresan sobre 100 y se calcula su\n                    promedio de acuerdo al porcentaje práctico/teórico de la\n                    materia.";
    			t3 = space();
    			strong0 = element("strong");
    			strong0.textContent = "Nuevo";
    			t5 = space();
    			p2 = element("p");
    			t6 = text("Esta aplicación puede ser instalada en teléfono mobiles\n                    gracias al .\n                    ");
    			a0 = element("a");
    			...
    			strong2.textContent = "aquí";
    			t12 = text("\n                    cómo hacerlo. ¡Gracias!");
    			t13 = space();
    			p3 = element("p");
    			p3.textContent = "Creado por Xavier Idrovo Vallejo";
    			t15 = space();
    			div4 = element("div");
    			div1 = element("div");
    			...
    			add_location(p1, file, 47, 16, 1195);
    			add_location(strong0, file, 52, 16, 1419);
    			attr_dev(a0, "href", "https://developer.mozilla.org/es/docs/Web/Progressive_web_apps");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "class", "svelte-260bdv");
    			add_location(a0, file, 56, 20, 1591);
    			add_location(strong1, file, 59, 20, 1781);
    			add_location(strong2, file, 64, 40, 2052);
    			attr_dev(a1, "href", "https://github.com/Xidrovo/calculadoraESPOL");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-260bdv");
    			add_location(a1, file, 62, 20, 1934);
    			add_location(p2, file, 53, 16, 1458);
    			add_location(p3, file, 67, 16, 2159);
    			...
    			add_location(div1, file, 70, 16, 2281);
    			attr_dev(a2, "href", "https://github.com/Xidrovo");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "class", "svelte-260bdv");
    			add_location(a2, file, 72, 20, 2397);
    			attr_dev(a3, "href", "https://www.linkedin.com/in/xavier-idrovo-vallejo-34a4b2119/");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "class", "svelte-260bdv");
    			add_location(a3, file, 75, 20, 2529);
    			attr_dev(div2, "class", "svelte-260bdv");
    			add_location(div2, file, 78, 20, 2697);
    			attr_dev(div3, "class", "flex flex-col social-media svelte-260bdv");
    			add_location(div3, file, 71, 16, 2336);
    			attr_dev(div4, "class", "flex flex-col social svelte-260bdv");
    			add_location(div4, file, 69, 12, 2230);
